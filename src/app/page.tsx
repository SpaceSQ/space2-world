          ...
          if (isSuccess) {
              ...
              if (outTradeNo) {
                  successMsg += lang === 'ZH'
                      ...
                      : `🧾 Order: ${outTradeNo}\n💰 Amount: $${totalAmount}\n🔗 TXN: ${alipayTradeNo}\n\nPermissions synced. Click OK to refresh your profile.`;
              }

              // 3. 弹出提示框阻塞页面
              alert(successMsg);

              // 🚀 4. 终极杀招：强制跳回首页并刷新页面，拉取最新账单！
...
{/* 🚀 修复点 2：使用 Array.isArray(session?.payments) 进行绝对安全的校验，彻底消灭 TS 报错，杜绝页面崩溃假死！ */}
